...
import com.sweettreats.SweetTreats.service.UserDetailsImplService;
...
public class SecurityConfig {
    ...
    @Bean
    public AuthenticationProvider authenticationProvider(PasswordEncoder passwordEncoder, UserDetailsImplService userDetailsImplService) {
